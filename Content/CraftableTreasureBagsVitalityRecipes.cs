	...
	public class CraftableTreasureBagsVitalityRecipes : ModSystem
	{
		...
		public override void AddRecipes()
		{
			if (!ModLoader.TryGetMod("VitalityMod", out var VitalityMod)) return;
			{
				...
				if (!ModContent.TryFind("VitalityMod/GemstoneElementalRelic", out ModItem GemstoneElementalRelic)) return; //VitalityMod
				...
				GemstoneElementalRelic.CreateRecipe().AddIngredient(ItemID.GoldBar, 25).AddIngredient(VitalityMod, "MultigemCluster").AddIngredient(ItemID.Geode, 3).AddIngredient(VitalityMod, "RubyPetItem").AddIngredient(VitalityMod, "GemstoneElementalMask").AddIngredient(VitalityMod, "GemstoneElementalTrophy").AddIngredient(VitalityMod, "GemstoneRing").AddIngredient(ItemID.GoldCoin, 10).AddTile(TileID.DemonAltar).AddTile(TileID.Anvils).Register(); //Gemstone Elemental (Gold)
				GemstoneElementalRelic.CreateRecipe().AddIngredient(ItemID.PlatinumBar, 25).AddIngredient(VitalityMod, "MultigemCluster").AddIngredient(ItemID.Geode, 3).AddIngredient(VitalityMod, "RubyPetItem").AddIngredient(VitalityMod, "GemstoneElementalMask").AddIngredient(VitalityMod, "GemstoneElementalTrophy").AddIngredient(VitalityMod, "GemstoneRing").AddIngredient(ItemID.GoldCoin, 10).AddTile(TileID.DemonAltar).AddTile(TileID.Anvils).Register(); //Gemstone Elemental (Platinum)
